<!-- CHANGE-RECORD
id: NTSD28-B6-NATIVE-IMPACT-HITPLAN-CARRIERS-PRODUCTION-001
status: FOCUSED_TEST_PASS
code-path: Assets/NTSD/Scripts/Simulation/Ecs/Hit/BattleEcsHitExecutionPlan.cs
code-path: Assets/NTSD/Scripts/Test/Editor/NTSD28B6NativeImpactHitPlanCarriersEditorTests.cs
authority: ??2026-09-10 Goal18???????playable impact??
evidence: RED_11_FAIL_2_PASS / FOCUSED_13_PASS / SHARED_PENDING
-->
...
I1????????9??field/capture6/sentinel/mask?????????????????????????EXE??SHA??B1E13AE17C86B77240B61A971AFD4C3374B645705F42B0BBCE304FD1D2819033?README_SOURCE?????playable build.ps1 coreSources67/74/76???playable game_session???????64?mask?????????????????????????????

????RED9/9????Temp/Goal18_I1_RED_Result.json?????mask?zero/HitConfirm????13?????RED???

???RED13?=11FAIL/2PASS???catch-source mask???control???Temp/Goal18_I1_RED2_Result.json????BattleEcsHitExecutionPlan CaptureWriterEffectSnapshot/WriterEffectSnapshot/DifferenceMask??environment?impact-source???38/31??projection?capture?????CODE_WRITTEN?focused???

I1 focused13/13 PASS?Temp/Goal18_I1_GREEN_Result.json?carrier???????????/?build/validator???????impact??????
