...
2026-09-25 original Editor follow-up: exact held-input tests `NativeResultContinueUsesHeldAttackAt144NotEarlier` and `NativeResultContinueAcceptsThirdParticipantButNotInactiveOrPressedOnly` passed 2/2, 0 failures in the original project Editor job `ab04cb260105498c929b6a1ff768c7c5`; the saved full job result is `artifacts/diagnostics/NTSD28-Q08-RESULT-CONTINUE-HELD-INPUT-001/original-editor-held-input-two-tests-20260925.json` (SHA-256 `386BCEF939E3362EF5B14A92ACD856CDEA8C4A47CD6253F28D91667E353C0B73`). No code or Scene file was changed by this follow-up, and the Scene SHA values are recorded in the Task. This is an original-project focused EditMode pass, not natural Play or formal EXE parity; `RUNTIME_PENDING` remains accurate.
