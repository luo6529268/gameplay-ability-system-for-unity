<!-- CHANGE-RECORD
id: NTSD28-Q06-FUSION-INPUT-FREEZE-001
status: VERIFIED
change-kind: FUSION_INPUT_FREEZE_AND_IDENTITY
code-path: Assets/NTSD/Scripts/Animation/LoganFusionCatalogInput.cs
code-path: Assets/NTSD/Scripts/Test/Editor/NTSD28Q06FusionInputFreezeEditorTests.cs
authority: Formal optional_global_dat and missing-only locked fusion table fallback.
evidence: Source path precedence/error/fallback audit; current content fingerprint excludes fusion input.
-->
