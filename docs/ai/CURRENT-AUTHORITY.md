...
> 最新恢复提示 2026-09-24：Q09/P-04自然同Z CentralOnly GPU限定出口已由原Battle Scene同SHA四Play完整tick5→6和独立四图全交集计算 VERIFIED：82/82像素符合OID120后绘制，44排除相反顺序、0支持相反。旧原位精确色探针字段0因稳定非白底色和边缘混色失效，不代表生产失败；原图/JSON/公式在 `NTSD28-Q09-SAME-Z-NATURAL-TICK-PIXEL-WITNESS-001/scene-471396E7-series/ANALYSIS.md`。原Editor已退出Play，Scene clean且哈希保持。Legacy/正式EXE A/B及其它Q09 P项仍待。旧R15 type3/action首差已修；D-024双坐标非体感差异还有OID219/fusion、复活/关系写者及整链门槛，Q07按用户先检非体感要求后置；D-025可行走区10秒例外已限定验证。Q08完整tick碰撞致死计时EditMode1/1仅限定通过。Q07～Q12及总目标开放。
...
> 2026-09-24 Q09/P-04 最新受控画面证据：`NTSD28-Q09-SAME-Z-FORMAL-SPRITE-PIXEL-WITNESS-001 / VERIFIED_CONTROLLED_CENTRAL_GPU_ONLY`。原Battle Scene正式OID120/121同Z命令大slot先绘，武器body交集11/11可区分像素为后绘制slot51颜色、0反例；原Editor编译0错、退出Play、对象/slot/两池/暂停及Scene SHA恢复。旧全屏误归因PASS已由严格body交集探针替代。自然完整tick、Legacy与正式EXE A/B仍待，P-04/Q09/总目标不关闭。证据见本包ACCEPTANCE。
