...
READY_READONLY / BATCH-03_ENTRY。硬前置Q05已经通过同版本恢复/回放/slot-pool及真实Scene恢复关闭重入，报告见 `artifacts/diagnostics/NTSD28-Q05-JOINT-SNAPSHOT-RESTORE-REPLAY-VALIDATION-001/REPORT.md`。先读CURRENT-AUTHORITY及对齐总表，不重做Q01～Q05已关闭合同、parser、载体、版本或加载基础。
