...
import type { DiagnosticEnvelope } from "../diagnostics/envelope.js";
import { compareUtf16CodeUnits } from "../sim/canonical.js";
import {
    expectArray,
    expectEnum,
    expectFiniteNumber,
...
export type TraceCategory = "system" | "parser" | "save" | "simulation";
...
const traceCategories = new Set<TraceCategory>(["system", "parser", "save", "simulation"]);
...
function parseJsonValue(value: unknown, path: ReadonlyArray<string | number>): JsonValue {
...
export const traceEnvelopeSchema = validator<TraceEnvelope>((value) => {
...
export function canonicalizeTraceEnvelope(value: TraceEnvelope): string {
