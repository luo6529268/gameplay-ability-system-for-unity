...
export const gate4MotionAuthorityLedger: AuthorityLedger = authorityLedgerSchema.parse({
    schemaVersion: 1,
    entries: [
        {
...
export function validateGate4MotionTraceRuleIds(values: readonly string[]): void {
