...
export const gate4bPresentationAuthorityLedger: AuthorityLedger = authorityLedgerSchema.parse({
    schemaVersion: 1,
    entries: [
        {
...
export function validateGate4bPresentationRuleIds(values: readonly string[]): void {
