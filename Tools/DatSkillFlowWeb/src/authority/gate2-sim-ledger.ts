...
export const gate2SimAuthorityLedger: AuthorityLedger = authorityLedgerSchema.parse({
    schemaVersion: 1,
    entries: [
        {
...
export function validateGate2TraceRuleIds(ruleIds: readonly string[]): void {
