...
export const gate3WpointAuthorityLedger: AuthorityLedger = authorityLedgerSchema.parse({
    schemaVersion: 1,
    entries: [
        {
...
export function validateGate3WpointTraceRuleIds(values: readonly string[]): void {
