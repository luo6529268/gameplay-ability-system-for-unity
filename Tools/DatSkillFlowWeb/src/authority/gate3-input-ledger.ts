...
export const gate3aInputAuthorityLedger: AuthorityLedger = authorityLedgerSchema.parse({
    schemaVersion: 1,
    entries: [
        {
...
export function validateGate3aInputTraceRuleIds(ruleIds: readonly string[]): void {
