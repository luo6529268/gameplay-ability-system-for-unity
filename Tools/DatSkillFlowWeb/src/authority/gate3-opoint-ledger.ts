...
export const gate3OpointAuthorityLedger: AuthorityLedger = authorityLedgerSchema.parse({
    schemaVersion: 1,
    entries: [
        {
...
export function validateGate3OpointTraceRuleIds(values: readonly string[]): void {
