...
export function syntheticPrefix(): Buffer {
...
export function independentlyEncryptDat(plaintext: Uint8Array, prefix = syntheticPrefix()): Buffer {
...
export function syntheticDatPlaintext(): Buffer {
...
export function syntheticDataTxt(): Buffer {
    return Buffer.concat([
...
export const cppDuplicateLoadFixture = Object.freeze([
    { id: 10, file: "chars\\missing.dat", outcome: "decrypt-failed" as const },
    { id: 10, file: "chars\\malformed.dat", outcome: "parse-failed" as const },
    { id: 10, file: "chars\\working-but-skipped.dat", outcome: "loaded" as const },
    { id: 11, file: "chars\\missing.dat", outcome: "decrypt-failed" as const },
    { id: 11, file: "chars\\working.dat", outcome: "loaded" as const },
]);

export function syntheticBmp(bitDepth: 8 | 24 | 32, width = 12, height = 6): Buffer {
