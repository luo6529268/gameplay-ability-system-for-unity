...
interface LoaderFixture {
    ...
    serverDependencyPath: string;
    testEntryPath: string;
    testDependencyPath: string;
    manifest: {
...
function outputEntry(path: string, buildId: string, bytes: Buffer) {
...
function runVerified(fixture: LoaderFixture, argumentsAfterImport: string[]) {
