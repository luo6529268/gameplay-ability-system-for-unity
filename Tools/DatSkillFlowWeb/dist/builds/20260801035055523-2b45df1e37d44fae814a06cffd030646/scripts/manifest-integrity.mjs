// dat-skill-flow-build:20260801035055523-2b45df1e37d44fae814a06cffd030646
...
export async function verifyManifestOutput({ staticRoot, manifestPath, outputPath }) {
    ...
    const entry = manifest.outputs.find((output) => output.path === outputPath);
    if (entry === undefined) {
        fail(outputPath, "output is missing from the current-build manifest");
    }
