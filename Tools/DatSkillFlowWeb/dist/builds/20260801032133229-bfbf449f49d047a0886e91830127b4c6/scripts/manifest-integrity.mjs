// dat-skill-flow-build:20260801032133229-bfbf449f49d047a0886e91830127b4c6
...
async function verifyExecutableOutput(canonicalRoot, entry) {
...
export async function loadVerifiedBuildManifest({ staticRoot, manifestPath }) {
    ...
    for (const executablePath of executablePaths) {
        ...
        verifiedPaths.set(executablePath, await verifyExecutableOutput(canonicalRoot, entry));
    }
