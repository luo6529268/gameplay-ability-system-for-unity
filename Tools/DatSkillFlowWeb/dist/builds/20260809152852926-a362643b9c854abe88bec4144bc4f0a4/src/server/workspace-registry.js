...
export class WorkspaceRegistry {
    ...
    async authorizeStartupRoot(absoluteRoot        )                     {
    ...
    async #registerAbsoluteRoot(absoluteRoot        )                     {
    ...
    async readLogicalFile(rootId        , logicalPath        )                  {
    ...
    async prepareDocumentRefresh(documentId        )                                   {
        const document = this.getDocument(documentId);
        let current;
        try {
            current = await this.#nativeClient.read({
