...
export class DatSessionService {
    ...
    #analyze(bytes            )                   {
        ...
        return { document: detected.document, encrypted: detected.encrypted, descriptors };
    }
    ...
    #newId()         {
        for (let attempt = 0; attempt < 128; attempt += 1) {
            ...
            if (typeof randomPart !== "string" || !/^[A-Za-z0-9_-]{32,}$/.test(randomPart)) continue;
            ...
            return `${randomPart}-${this.#nextIdSequence.toString(36)}`;
        }
