...
export const gate3aInputAuthorityLedger                  = authorityLedgerSchema.parse({
    ...
    entries: [
        ...
        },
        {
            ...
            summary: "In nonzero PP mode, the target frame charges mp%1000 PP and floor(mp/1000)*10 HP with strict preconditions and records both display accumulators.",
            status: "authoritative",
            source: {
                file: `${cppRoot}\\src\\input\\input_handler.cpp`,
                function: "do_frame_jump",
