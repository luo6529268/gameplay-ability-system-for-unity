// dat-skill-flow-build:20260801031025720-aae52eb1dc254ff7901b42a773a755a2
...
export async function loadVerifiedBuildManifest({ staticRoot, manifestPath }) {
    ...
    const manifest = parseManifest(JSON.parse(await readFile(canonicalManifestPath, "utf8")));
