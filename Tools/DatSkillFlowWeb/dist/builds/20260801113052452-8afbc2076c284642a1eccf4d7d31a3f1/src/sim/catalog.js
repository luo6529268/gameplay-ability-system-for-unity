...
export function normalizeFrames(frames                               )                                {
    ...
    for (const candidate of frames) {
        ...
        const normalized = Object.freeze({
            ...
            dvx: safeInteger(candidate.dvx ?? 0, "frame.dvx"),
            dvy: safeInteger(candidate.dvy ?? 0, "frame.dvy"),
            dvz: safeInteger(candidate.dvz ?? 0, "frame.dvz"),
...
function normalizeDat(candidate   
    ...
    return Object.freeze({
        ...
        jumpHeight: finiteNumber(candidate.jumpHeight ?? 0, "catalog.jumpHeight"),
        jumpDistance: finiteNumber(candidate.jumpDistance ?? 0, "catalog.jumpDistance"),
        jumpDistanceZ: finiteNumber(candidate.jumpDistanceZ ?? 0, "catalog.jumpDistanceZ"),
        frameSourceIndex: -1,
