...
function normalizeEntity(
    ...
    return Object.freeze({
        ...
        knockbackVx: requireFinite(seed.knockbackVx ?? 0, "entity.knockbackVx"),
        knockbackVy: requireFinite(seed.knockbackVy ?? 0, "entity.knockbackVy"),
        knockbackVz: requireFinite(seed.knockbackVz ?? 0, "entity.knockbackVz"),
...
export function stepSimulation(
    ...
    const pickupResult = applyPickupInputs(working, parsePickupInputs(normalizedInput                   ));
