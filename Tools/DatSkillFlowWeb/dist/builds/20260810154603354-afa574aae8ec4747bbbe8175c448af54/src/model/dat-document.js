...
export function createSetScalarCommand(
    ...
    return { kind: "set-scalar", name, field, value, valueKind };
}
...
export function createSetIntegerPairCommand(
    ...
    field             ,
    value                           ,
    allowMissingSourcePair = false,
)                        {
    return { kind: "set-integer-pair", name, field, value, allowMissingSourcePair };
}
...
function replacementForCommand(command                  )                          {
    ...
    const scalarKind = command.valueKind ?? command.field.scalarKind;
...
function replacementForIntegerPair(command                       )                          {
    ...
    if (command.field.blockType !== "itr"
        ...
        || (command.field.integerPairValue === undefined && command.allowMissingSourcePair !== true)) {
