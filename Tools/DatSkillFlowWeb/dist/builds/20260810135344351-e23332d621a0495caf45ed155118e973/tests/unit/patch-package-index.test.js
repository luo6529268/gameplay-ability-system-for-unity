...
describe("patch package index", () => {
    ...
    it("rejects absolute paths, traversal, unknown DAT records and duplicate package ids", () => {
        ...
        assert.throws(() => parsePatchPackageIndex({ ...base, packages: [{ ...base.packages[0], records: [{ oid: 1, type: 0, file: "b.dat", logicalPath: "pkg/b.dat", manifestSource: "source" }] }] }), /not present/);
