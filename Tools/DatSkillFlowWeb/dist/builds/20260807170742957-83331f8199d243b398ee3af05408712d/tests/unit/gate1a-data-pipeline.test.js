...
describe("Gate1A BMP and sprite metadata", () => {
    ...
    it("looks up inclusive ranges, treats col as columns, uses w+1/h+1 stride, and suppresses pic 999", () => {
        ...
        assert.deepEqual(resolveSpriteFrame(24, ranges), {
            ...
            column: 0,
            row: 2,
            source: { x: 0, y: 6, width: 3, height: 2 },
        ...
        assert.deepEqual(resolveSpriteFrame(29, ranges), {
            ...
            column: 1,
            row: 4,
            source: { x: 4, y: 12, width: 3, height: 2 },
            colorKey: { enabled: true, red: 0, green: 0, blue: 0 },
