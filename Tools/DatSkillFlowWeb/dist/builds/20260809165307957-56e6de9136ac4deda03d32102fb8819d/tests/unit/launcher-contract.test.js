...
describe("one-click launcher contract", () => {
    ...
    it("publishes after the first scene while verified entry previews keep warming in the background", async () => {
        ...
        assert.match(cli, /Preparing DAT catalog and first playable scene/);
