...
function bindFrameSources(
                                                                                      ...
                                                                                      
  {
    ...
    const seedBindings = seeds.map((seed) => {
        ...
        const candidate = explicit?.frames ?? normalizeFrames(seed.frames);
        const index = register(candidate);
...
export function createSimulation(options                         )                  {
    ...
    const bindings = bindFrameSources(initialCatalog, options.entities, explicitOids);
