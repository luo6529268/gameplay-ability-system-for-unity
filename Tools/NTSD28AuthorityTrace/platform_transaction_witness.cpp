...
static void run_case(const PlatformCase& c) {
    ...
    request.position.x = 100; request.position.y = -20; request.position.z = 250;
    ...
    target.collision_y_reference = -999;
    target.platform_source_slot_f4 = 99;
    target.render_shadow_offset_10c = -999;
