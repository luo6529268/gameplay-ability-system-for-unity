...
timestamp: "2026-07-17T03:06:24.527Z"
---
...
namespace NTSD.Simulation
{
    public partial class SimulationWorld
    {
        ...
        internal bool TryResolveRosterInputEntity(int playerSlot, out LF2Entity entity)
        {
            ...
            if (rosterSlot == null || !rosterSlot.Active || !rosterSlot.IsHuman)
                return false;
        ...
        {
            if (candidate?.Runtime == null || !IsActiveForCurrentPass(candidate) || candidate.AiControlled)
                return false;
