        ...
        public static void Run()
        {
            ...
            try
            {
                ...
                Require(sprite.LocalOffsetPixels == new Vector2(11, 9) &&
                    (renderer == null || renderer.transform.localPosition == testPosition) && entity.Effect.OscillateDirection == 1,
                    "Old amplitude moved the actual renderer");
                ...
                Require(!sprite.EntityVisible && (renderer == null || !renderer.enabled) && entity.Effect.BlinkCounter == 1,
                    "Old amplitude suppressed Blink");
                ...
                Require(entity.Effect.Num == -99 && !entity.Effect.Stuck && !entity.Effect.Super &&
                    ...
                    entity.Effect.Oscillate == 7 && entity.Effect.OscillateDirection == 1 &&
                ...
                report.status = "PASS";
                report.message = "Synthetic old-effect injection on an existing Play character; production ProcessEffects and presentation snapshot capture verified; renderer checks when bound.";
            }
