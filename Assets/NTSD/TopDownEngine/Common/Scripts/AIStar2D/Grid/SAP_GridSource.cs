    ...
    public class SAP_GridSource
    {
        ...
        public GridPivot GridPivot
        {
            ...
            set
            {
                ...
                if (gridPivot == GridPivot.SelfPosition) gridPosition = _SelfPosition;
                SetCenterPosAccordingToPivot();
            }
        }
        ...
        private void SetCenterPosAccordingToPivot()
        {
            ...
            if (gridPivot == GridPivot.SelfPosition) gridBounds.center = new Vector2(_SelfPosition.x + gridBounds.extents.x, _SelfPosition.y + gridBounds.extents.y);
