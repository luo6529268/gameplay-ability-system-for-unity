...
namespace MoreMountains
{
    ...
    public class SAP2DPathfinder : MMSingleton<SAP2DPathfinder> 
    {
        public int gridsCount => grids.Count;

        #if UNITY_EDITOR
        //editor data
        public List<SAP_GraphDrawer> GraphDrawers = new List<SAP_GraphDrawer>();
        public SAP2DEditorSettings EditorSettings;
        #endif
        ...
        public void AddGrid(int width = 10, int height = 10)
        {
            ...
            newGrid._SelfPosition = this.transform.position;
            grids.Add(newGrid);
