...
namespace MoreMountains.Tools
{
	...
	public abstract class AIDecision : MonoBehaviour
	{
		...
		/// <summary>
		/// Meant to be overridden, called when the Brain enters a StateNode this Decision is in
		/// </summary>
		...
		/// <summary>
		/// Meant to be overridden, called when the Brain exits a StateNode this Decision is in
		/// </summary>
