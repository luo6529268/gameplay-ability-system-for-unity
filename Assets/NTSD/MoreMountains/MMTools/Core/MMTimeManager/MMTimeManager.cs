...
namespace MoreMountains.Feedbacks
{
    ...
    /// 用于插值时间缩放的可能模式。
	/// 速度（Speed）是遗留模式，如果您想要插值时间缩放，推荐使用持续时间（Duration）模式，它提供了最多的选项和准确性。
    /// </summary>
    ...
    /// 将此组件放入您的场景中，它将捕获 MMFreezeFrameEvents 和 MMTimeScaleEvents，允许您控制时间的流逝。
    /// </summary>
	...
	{	
        ...
        // 参考时间缩放，系统在所有时间变化后将恢复到此设置
        [Tooltip("参考时间缩放，系统在所有时间变化后将恢复到此设置")]
        public float NormalTimeScale = 1f;

        [Header("Impacted Values")]
        /// 更改时间缩放时是否更新Time.timeScale
        [Tooltip("更改时间缩放时是否更新Time.timeScale")]
        public bool UpdateTimescale = true;
        /// 更改时间缩放时是否更新Time.fixedDeltaTime
        [Tooltip("更改时间缩放时是否更新Time.fixedDeltaTime")]
        public bool UpdateFixedDeltaTime = true;
        /// 更改时间缩放时是否更新Time.maximumDeltaTime
        [Tooltip("更改时间缩放时是否更新Time.maximumDeltaTime")]
