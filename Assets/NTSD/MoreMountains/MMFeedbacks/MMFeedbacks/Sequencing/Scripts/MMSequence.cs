...
namespace MoreMountains.Feedbacks
{
	...
	/// <summary>
	/// A class describing the properties of a sequence's track : ID, color (for the inspector), Key (for the recorder), StateNode (for the recorder)
	/// </summary>
	[System.Serializable]
	public class MMSequenceTrack
	{
		...
		[MMFReadOnly]
		public MMSequenceTrackStates StateNode = MMSequenceTrackStates.Idle;
		[HideInInspector]
		...
		public virtual void SetDefaults(int index)
		{
			if (!Initialized)
			{
				...
				Key = KeyCode.Space;
				Active = true;
				StateNode = MMSequenceTrackStates.Idle;
				Initialized = true;
			}            
		}
	}
