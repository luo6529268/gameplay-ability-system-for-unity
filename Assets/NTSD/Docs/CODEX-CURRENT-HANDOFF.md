...
2026-09-24 D-024 active `NTSD28-USER-SOURCE-CPOINT-HELD-POSITION-001 / IN_PROGRESS`: precise script scope and rollback registered before held CPoint source X/Z edits. Native nonzero CPoint Z versus Unity physical branch is a distinct confirmed gap; do not call parity closed or resume Q07.
