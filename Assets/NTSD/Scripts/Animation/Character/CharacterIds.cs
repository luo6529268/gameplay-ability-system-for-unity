namespace NTSD.Animation
{
    ...
    /// 反汇编中存在特判分支的角色：ID=6(Hsasori), ID=7(RockLee), ID=8(Chiyo), ID=11(Sasuke)
    /// </summary>
    public static class CharacterIds
    {
        ...
        public const int Hsasori     = 6;   // 反汇编 0x00414B82: cmp [ecx+6F4h], 6
        public const int RockLee     = 7;   // 反汇编 0x004085AB 附近
        public const int Chiyo       = 8;   // 反汇编 0x0040AC31: cmp [ecx+6F4h], 8
        public const int Itachi      = 9;
        public const int Deidara     = 10;
        public const int Sasuke      = 11;  // 反汇编 0x0040AF81: cmp [ecx+6F4h], 0Bh
