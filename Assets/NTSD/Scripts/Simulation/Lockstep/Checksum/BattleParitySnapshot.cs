    ...
    internal sealed class BattleParitySnapshotModule
    {
            ...
            bool includePresentationHitRecords = true)
        {
            ...
            object frame = DictionaryOf(
                ...
                ("soundActionLatch", isDefault ? -1 : runtime.NativeSoundActionLatch),
                ("nativeRuntimeStateCode", isDefault ? 0 : runtime.NativeRuntimeStateCode),
                ("nativeLifecycleResolutionPending", !isDefault && runtime.NativeLifecycleResolutionPending),
                ("nativeLifecycleCode", isDefault ? 0 : runtime.NativeLifecycleCode),
